...
class TelegramClient:
    ...
    def _create_send_media(self) -> Function:
        ...
        send_media = Function(
            ...
            config=FunctionConfig(
                ...
                platform="telegram",
                headers={"Content-Type": "application/json"},
                payload={"chat_id": "{{chat_id}}", "{{media_type}}": "{{media}}", "caption": "{{caption}}"},
    ...
    def _create_poll(self) -> Function:
        ...
        create_poll = Function(
            ...
            args=[
                FunctionArgument(name="chat_id", description="Chat where the poll will be created", type="string"),
                FunctionArgument(
    ...
    def _create_pin_message(self) -> Function:
        ...
        pin_message = Function(
            ...
            args=[
                FunctionArgument(name="chat_id", description="Chat where the message will be pinned", type="string"),
                FunctionArgument(
                    name="message_id",
    ...
    def _create_delete_message(self) -> Function:
        ...
        delete_message = Function(
            ...
            args=[
                FunctionArgument(name="chat_id", description="Chat containing the message to delete", type="string"),
                FunctionArgument(
                    name="message_id",
